<template>
  <div class="login_box">
      ...
      <el-col :xs="24" :sm="12">
        <div class="login_out_box  flex-center-x-y">
          <div class="login_from ">
            ...
            <el-form :model="formInfo" label-width="0px" :rules="rules" ref="formRef" status-icon>
              ...
              <el-form-item>
                <el-checkbox v-model="checkRemember" class="login_check" label="记住密码" />
              </el-form-item>
              <el-form-item>
    ...
    <!-- 拼图验证 -->
    <Vcode :show="showVerify" @success="onSuccessVerify" @close="showVerify = false" 
   />
...
const rules = reactive<FormRules<RuleForm>>({
  username: [
    ...
    { min: 1, max: 15, message: '账号长度应为1-15位', trigger: ['blur', 'change'] },
  ],
  password: [
...
onMounted(() => {
  //判断是否有之前记住的密码
  if (Object.keys(userStore.rememberUser).length != 0) { //在el输入框直接拿到的都是字符串
