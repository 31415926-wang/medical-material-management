...
enum Urls {
    list_url = '/business/consumer/findConsumerList',
    add_url = '/business/consumer/add',
    update_url = '/business/consumer/update',
    datail_item_url = '/business/consumer/edit',
    delete_item_url = '/business/consumer/delete',
